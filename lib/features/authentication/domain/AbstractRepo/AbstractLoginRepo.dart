...
abstract class AbstractLoginRepo {
  Future<Either<Failure, LoginEntity>> loginWithUsernameAndPassword(String username, String password, String appVersion, String appVersionDate, String deviceId);
